...
public class EmailService {
    ...
    private final JavaMailSender mailSender; // EmailConfig.java파일의 mailSender bean객체가 주입. G-Mail SMTP 메일 서버 정보
    ...
    // 단순 메시지를 포함한 메일 발송
    // String message : 메일에 보낼 내용  예>회원가입시 메일인증코드, 임시비밀번호
    // String type : message변수가 사용될 템플릿 html파일 이름. mail폴더 확인
    public void sendMail(String type, EmailDTO dto, String message) {
        // message변수의 내용을 템플릿 html파일에 적용했을 때 결과 HTML Code
